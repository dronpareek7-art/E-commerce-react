    ...
    <div className="about">
      <div className="about-header">
        ...
        <p>
          ...
          experience. Our goal is to make shopping easy, fast and reliable for
          everyone.
        </p>
      </div>
      ...
      <div className="about-cards">
        <div className="about-card">
          ...
          <h3>Fast Delivery</h3>
          <p>
            We ensure quick and reliable delivery so that your products reach
            you on time.
          </p>
        </div>
        ...
        <div className="about-card">
          ...
          <p>
            Your payments are completely safe and protected with secure checkout
            systems.
          </p>
        </div>
        ...
        <div className="about-card">
          ...
          <h3>Best Prices</h3>
          <p>
            We provide the best quality products at affordable prices for our
            customers.
          </p>
        </div>
